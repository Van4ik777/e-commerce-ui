...
const menuItems1 = ['Catalog', 'Sale', 'Offline store', 'About us', 'Calculator', 'Contacts'];
const menuItems2 = ['Privacy Police', 'Paymant & Delivery', 'Q&A'];

const menuItems3 = ['Instagram', 'Facebook', 'Twitter'];
